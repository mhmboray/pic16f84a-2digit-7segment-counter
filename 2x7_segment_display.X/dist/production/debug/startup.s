	...
	; -Mdist/production/debug/2x7_segment_display.X.debug.map -D__DEBUG=1 \
	; --debugger=none -DXPRJ_production=production \
	...
	; --summarydir=dist/production/debug/memoryfile.xml \
	; -o2x7_segment_display.X.debug.elf --objdir=dist/production/debug \
	; --outdir=dist/production/debug \
	; build/production/debug/7segmentdisplay.p1 -L--fixupoverflow=error \
