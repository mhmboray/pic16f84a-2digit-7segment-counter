	...
	; -Mdist/production/production/2x7_segment_display.X.production.map \
	; -DXPRJ_production=production -L--defsym=__MPLAB_BUILD=1 \
	...
	; --summarydir=dist/production/production/memoryfile.xml \
	; -o2x7_segment_display.X.production.elf \
	; --objdir=dist/production/production \
	; --outdir=dist/production/production \
	; build/production/production/7segmentdisplay.p1 \
